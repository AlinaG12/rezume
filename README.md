...
3. конкурсы: Траектория будущего(https://tbolimpiada.ru/onenews/241) добавить ссылку на папку с сертификатами участие в полуфинале траектории отменяет доктрину(https://xn----ftbd3ambmkj6fta.xn--p1ai/index.htm) и интеграцию(https://integraciya.org/konkursy/)(должен быть сертификат), IT планета, доктрина или интергация
